                            ...
                            <div className="profile-picture">
                                ...
                                <div className="new__icons d-flex mb-4 mx-4">
                                    <div className="dropdown">
                                        <a className="caret__dropdown dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-expanded="false">

                                            <Image className="img-fluid" src="/assets/images/promonew/29.png" alt="" fill />
                                        </a>
                                        <div className="dropdown-menu dropdown__menu__profile shadow-sm" aria-labelledby="dropdownMenuLink">
                                            <a className="dropdown-item d-flex" href="#">
                                                <div className="drop_icon_img">
                                                    <Image className="w-100" src="/assets/images/shareicon.png" alt="" fill />
                                                </div>
                                                <div className="dropdown_text"> Share Profile </div>
                                            </a>
                                            <a className="dropdown-item d-flex" href="#">
                                                <div className="drop_icon_img">
                                                    <Image className="w-100" src="/assets/images/promonew/bell.png" alt="" fill />
                                                </div>
                                                <div className="dropdown_text"> ignore notifications </div>
                                            </a>
                                            <a className="dropdown-item d-flex" href="#">
                                                <div className="drop_icon_img">
                                                    <Image className="w-75" src="/assets/images/promonew/block.png" alt="" fill />
                                                </div>
                                                <div className="dropdown_text"> block </div>
                                            </a>
                                            <a className="dropdown-item d-flex" href="#">
                                                <div className="drop_icon_img">
                                                    <Image className="w-75" src="/assets/images/notes.png" alt="" fill />
                                                </div>
                                                <div className="dropdown_text"> report </div>
                                            </a>
                                            <a className="dropdown-item d-flex" href="#">
                                                <div className="drop_icon_img">
                                                    <Image className="w-100" src="/assets/images/promonew/friend.png" alt="" fill />
                                                </div>
                                                <div className="dropdown_text"> request friendship consideration </div>
                                            </a>
                                            <a className="dropdown-item d-flex" href="#">
                                                <div className="drop_icon_img">
                                                    <Image className="w-100" src="/assets/images/promonew/friends.png" alt="" fill />
                                                </div>
                                                <div className="dropdown_text"> become friends with... </div>
                                            </a>
                                            <a className="dropdown-item d-flex" href="#">
                                                <div className="drop_icon_img">
                                                    <Image className="w-100" src="/assets/images/promonew/jurror.png" alt="" fill />
                                                </div>
                                                <div className="dropdown_text"> Appoint as K-Juror </div>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="ml-auto">
                                        <div className="image_grids">
                                            <div className="image_back">
                                                <Image className="profile_chat_img" src="/assets/images/chat_icon.png" alt="" fill />
                                            </div>

                                            <div className="image_back">
                                                <Image className="profile_chat_img" src="/assets/images/square_plus.png" alt="" fill />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="follow-user-section">
                            <ul className="nav nav-pill my-nav-pills-follow nav-justified">
                                <li className="nav-item text-start">
                                    <a className="nav-link d-inline-block px-1 nav-item-follow" onClick={(e) => popupfollowing('following')}>
                                ...
                                <li className="nav-item text-end">
                                    <a className="nav-link d-inline-block px-1 nav-item-follow" onClick={(e) => popupfollowing('followers')}>
                                        <p className="m-0 totfolloeing"> <Image src="/assets/images/audience_round.png" alt="" className="sqares_img" fill />
                                            <span className="lightdarktxt bold600 suare_hover">Audience</span></p>
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div id="following" className="popup_follow d-none">
                                ...
                                <div className="all_following_list">
                                    <div className="d-flex flex-row align-items-center spec_follow_item border-bottom-custom user-info">
                                        ...
                                        <div className="ml-auto follow-image pos_relative mr-2">
                                            <Link href="/site/suggested_profile">
                            ...
                            <div id="followers" className="popup_follow d-none">
                                ...
                                <div className="all_following_list">
                                    <div className="d-flex flex-row align-items-center spec_follow_item border-bottom-custom user-info">
                                        ...
                                        <div className="ml-auto follow-image pos_relative mr-2">
                                            <Link href="/site/suggested_profile">
                                                <Image className="suggested_profile_icon" src="/assets/images/aud_circle.png" alt="" width="30" height="30" />
                                            </Link>
                                        </div>
                                    </div>
                                    <div className="d-flex flex-row align-items-center spec_follow_item border-bottom-custom user-info">
                            ...
                            <div className="side_by_side">
                                ...
                                <div className="left_sided_part">
                                    <div className="loremTexts max_content_sizing">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id bibendum nibh. Nullam massa
                                        enim, posuere eget turpis id, fermentum varius sem. Proin tincidunt tempus mi, a fermentum
                                        ipsum finibus in. Praesent mollis nunc id libero fringilla consequat.
                                    </div>
                                    <div className="linksHolder">
                                        <p className="iconbar">
                                            <span><span className="icons"> <Image src="/assets/images/basket.png" alt="" className="iconimg" fill /> </span>
                                            ...
                                            <span className="gray_small"> <span className="icons"> <span className="dots"></span>
                                                <Image src="/assets/images/bookmarks.png" alt="" className="iconimg m-0" fill /> </span> Bookworms
                                            </span>

                                            <span className="gray_small"> <span className="icons"> <span className="dots"></span>
                                                <Image src="/assets/images/arts.png" alt="" className="iconimg m-0" fill /> </span> Arts </span>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="right_sided_part">
                                    <p className="iconbar">
                                        ...
                                        <a className="link" href="https://www.zoe.com/">www.zoe.com</a>
                                    </p>
                                    <p className="iconbar">
                                        <span className="icons"> <Image src="/assets/images/whinny.png" alt="" className="iconimg" fill /> </span>
                                        <a className="link" href="https://whinny.com/">whinny.com </a> <br />
                                        <a className="link custom_margin" href="https://inteswitch.com/"> inteswitch.com</a>
                                    </p>
                                    <p className="iconbar">
                                        <span className="icons"> <Image src="/assets/images/florida.png" alt="" className="iconimg" fill /> </span>
                            ...
                            <div className="modal-dialog modal-sm modal-dialog-centered" role="document">
                                <div className="modal-content">
                                    <div className="scroll-follow">
                                        ...
                                        <div className="p-2 followers-section" id="followers" role="tabpanel" aria-labelledby="bio-profile-tab">
                                            ...
                                            <div
                                                ...
                                                <div className="d-flex">
                                                    <div className="dropdown">
                                                        <button type="button" className="btn follow-btn  btn-success dropdown-toggle"
                                ...
                                <div className="modal-content">
                                    ...
                                    <div className="scroll-follow">
                                        ...
                                        <div className="p-2 following-section" id="following">
                                            ...
                                            <div className="d-flex flex-row justify-content-center border-bottom-follow user-info pb-2">
                                                <Image className="rounded-circle" src="/assets/images/8.png" alt='' height="50" width="50" />
                                                <div className="d-flex flex-column justify-content-start ml-1 mr-4">
                                                ...
                                                <div className="d-flex">
                                                    <div className="dropdown">
                                                        <button type="button" className="btn text-white follow-btn bg-kchat dropdown-toggle"
                                                            data-toggle="dropdown">
                                                            Following
                                                        </button>
                                                        <div className="dropdown-menu">
                                            ...
                                            <div className="d-flex flex-row justify-content-center border-bottom-follow user-info pb-2">
                                                ...
                                                <div className="d-flex">
                                                    <Link href="#/"> <button type="button" className="btn follow-btn  btn-danger">Block</button>
                                                    </Link>
                                                </div>
                                            </div>
                            ...
                            <div className="main_bio_section white_bg_common common_input_sections">
                                ...
                                <div className="main-tags-inputs">
                                    ...
                                    <div className="profile_detail_text">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id bibendum nibh. Nullam massa enim,
                                        posuere eget turpis id, fermentum varius sem. Proin tincidunt tempus mi, a fermentum ipsum finibus
                                    ...
                                    <div className="d-flex">
                                        <div className="hobbieDivs">reading</div>
                                        <div className="hobbieDivs">travelling</div>
                                        <div className="hobbieDivs">Favorite athlete(s)</div>
                                    </div>
                                    ...
                                    <div className="d-flex">
                                        <div className="hobbieDivs">reading</div>
                                        <div className="hobbieDivs">music</div>
                                        <div className="hobbieDivs">movie</div>
                                    </div>
                                    ...
                                    <div className="text-dark intro-title">interests and hobbies</div>
                                    <div className="d-flex">
                                        <div className="hobbieDivs">reading</div>
                                        <div className="hobbieDivs">music</div>
                                        <div className="hobbieDivs">movie</div>
                                    ...
                                    <div className="text-dark intro-title">FAVORITE others </div>
                                    <div className="d-flex">
                                        <div className="hobbieDivs"> athelets </div>
                                    </div>


                                    <div className="text-dark intro-title">FAVORITE athelets </div>
                                    <div className="d-flex">
                                        <div className="hobbieDivs">reading</div>
                                        <div className="hobbieDivs">music</div>
                                        <div className="hobbieDivs">movie</div>
