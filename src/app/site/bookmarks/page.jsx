                    ...
                    <div className="row restbars">
                        <div className="col-sm-7 col-md-7 col-lg-8 customrightpadding">
                            ...
                            <div className="flex-buttons mb-3">
                                <Link href="/site/bookmarks" className="inertButton activatedbtn">Saved <span className="totalmarks">(5)</span> </Link>
                                <Link href="/site/drafts" className="inertButton">Drafts <span
