...
export default function KhrimiPage() {
    ...
    const activateButton = (passedThis) => {
        $(".terms_btn").removeClass("activated_btn");
        $(passedThis).addClass("activated_btn");
            ...
            <div className="legal_rows">
                ...
                <div className="right_contents">
                    <div className="terms_buttons">
                        <div className="terms_btn activated_btn" onClick={(e) => activateButton(e.target)} data-id="terms_use">Terms of Use
                        </div>
                        <div className="terms_btn" onClick={(e) => activateButton(e.target)} data-id="terms_aggrement">Terms of Agreement</div>
                    </div>
